...
cat my_stock/del-app/OppoVideoEditor/OppoVideoEditor.apk.* 2>/dev/null >> my_stock/del-app/OppoVideoEditor/OppoVideoEditor.apk
rm -f my_stock/del-app/OppoVideoEditor/OppoVideoEditor.apk.* 2>/dev/null
cat my_preload/del-app/realme_Link_exp/realmeLink-releaseExp-1.2.258.12_470_50937ab_202101281942_signed.apk.* 2>/dev/null >> my_preload/del-app/realme_Link_exp/realmeLink-releaseExp-1.2.258.12_470_50937ab_202101281942_signed.apk
rm -f my_preload/del-app/realme_Link_exp/realmeLink-releaseExp-1.2.258.12_470_50937ab_202101281942_signed.apk.* 2>/dev/null
cat my_preload/del-app/CupidA_20662_Snapchat/Snapchat_11.6.2.66.apk.* 2>/dev/null >> my_preload/del-app/CupidA_20662_Snapchat/Snapchat_11.6.2.66.apk
rm -f my_preload/del-app/CupidA_20662_Snapchat/Snapchat_11.6.2.66.apk.* 2>/dev/null
